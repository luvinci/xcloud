...
type UploadService interface {
	// 获取上传入口地址
	UploadEntry(ctx context.Context, in *EntryReq, opts ...client.CallOption) (*EntryResp, error)
}
...
func (c *uploadService) UploadEntry(ctx context.Context, in *EntryReq, opts ...client.CallOption) (*EntryResp, error) {
...
type UploadServiceHandler interface {
	// 获取上传入口地址
	UploadEntry(context.Context, *EntryReq, *EntryResp) error
}

func RegisterUploadServiceHandler(s server.Server, hdlr UploadServiceHandler, opts ...server.HandlerOption) error {
	type uploadService interface {
		UploadEntry(ctx context.Context, in *EntryReq, out *EntryResp) error
	}
	type UploadService struct {
		uploadService
	}
...
func (h *uploadServiceHandler) UploadEntry(ctx context.Context, in *EntryReq, out *EntryResp) error {
